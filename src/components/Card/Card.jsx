...
const Card = ({ displayFilter, element, serviceType }) => {

    const navigate = useNavigate();

    return (
        <div>
            <div onClick={() => navigate(`/service-details?id=${element._id}&serviceType=${serviceType}`)} className={`card card-compact bg-base-100 shadowCustom shadow-black rounded-md cursor-pointer ${displayFilter ? 'w-48 md:w-64' : 'w-72'}`}>
                ...
                <div className="py-2 px-2 bg-green-50 rounded-md">
                    ...
                    <p className="text-gray-500">৳{element.price}</p>
